...
- [Complete Architecture Visual Guide](https://pong1013.github.io/gcp-solutions-repo/complete/complete-architecture-visual.html)：互動式 HTML，說明 complete 架構、8 個 production-grade 實作步驟、每一步的目的與需求對應，以及完整治理方案的取捨。
